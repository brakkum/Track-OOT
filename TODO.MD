...
- map exits marker not updating after check/uncheck
- list exits not updating after check/uncheck
...
- locations sometimes cant be unchecked directly
    - locations need to be unchecked twice before state gets saved
